...
export default function CookieBanner() {
  ...
  return (
    <AnimatePresence>
      {isVisible && (
        <>
          {/* Overlay de fondo que bloquea interacción */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 text-sm leading-relaxed font-light">
                        ...
                        experiencia de navegación, analizar el tráfico del sitio
                        y personalizar el contenido. Tus favoritos se guardarán
                        de forma segura durante todo el año.
                      </p>
                        ...
                        {showDetails && (
                          ...
                          >
                            <div className="p-4 bg-gray-50 border border-gray-100">
                              <div className="flex items-start gap-3 mb-3 pb-3 border-b border-gray-200">
                                ...
                                <div>
                                  ...
                                  <p className="text-xs text-gray-600 font-light">
                                    ...
                                    sitio, como el carrito de compras y la
                                    sesión.
                                  </p>
                                </div>
                              </div>
                              ...
                              <div className="flex items-start gap-3 mb-3 pb-3 border-b border-gray-200">
                                ...
                                <div>
                                  ...
                                  <p className="text-xs text-gray-600 font-light">
                                    Permiten guardar tus preferencias
                                    (favoritos, idioma) durante 365 días.
                                  </p>
                                </div>
                              </div>
                            ...
                            <p className="text-xs text-gray-500 font-light">
                              Puedes cambiar tus preferencias en cualquier
                              momento desde la{" "}
                              <a
                                href="/privacidad"
