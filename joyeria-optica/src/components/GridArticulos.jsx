export default function GridArticulos() {
  return (
    <div className="grid grid-cols-2 gap-2 min-[1280px]:grid-cols-6">
      <a href="/catalogo/anillos" className="transition-transform duration-300 ease-in-out hover:scale-115 hover:text-yellow-500">
      ...
      <a href="/catalogo/pendientes" className="transition-transform duration-300 ease-in-out hover:scale-115 hover:text-yellow-500">
        <div className="flex justify-center">
          <img
      ...
      <a href="/catalogo/collares" className="transition-transform duration-300 ease-in-out hover:scale-115 hover:text-yellow-500">
        <div className="flex justify-center">
          <img
      ...
      <a href="/catalogo/pulseras" className="transition-transform duration-300 ease-in-out hover:scale-115 hover:text-yellow-500">
        <div className="flex justify-center">
          <img
      ...
      <a href="/catalogo/relojes" className="transition-transform duration-300 ease-in-out hover:scale-115 hover:text-yellow-500">
        <div className="flex justify-center">
          <img
      ...
      <a href="/catalogo/gafas" className="transition-transform duration-300 ease-in-out hover:scale-115 hover:text-yellow-500">
        <div className="flex justify-center">
          <img
